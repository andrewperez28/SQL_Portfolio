...
function TrainersTableRow({ trainersEntry }) {
  return (
    <tr>
      <td>{trainersEntry.trainer_id}</td>
      <td>{trainersEntry.trainer_name}</td>
      <td>{trainersEntry.hometown}</td>
      <td>{trainersEntry.num_badge}</td>
      <td>{trainersEntry.trainer_type}</td>
    </tr>
  );
}
