...
import PkmnNumsTableRow from "./PkmnNumsTableRow";

function PokemonNumbersTable() {
  ...
  return (
    <table>
      ...
      <tbody>
        {pokedexList.map((pkmnNumsEntry, i) => (
          <PkmnNumsTableRow pkmnNumsEntry={pkmnNumsEntry} key={i} />
        ))}
      </tbody>
    </table>
  );
...
export default PokemonNumbersTable;
