...
import PkmnAndMovesTableRow from "./PkmnAndMovesTableRow";

export default function PkmnandMovesTable() {
  ...
  return (
    <>
      <table>
        ...
        <tbody>
          {pmList.map((pmEntry, i) => (
            <PkmnAndMovesTableRow pmEntry={pmEntry} key={i} />
          ))}
        </tbody>
      </table>
    </>
